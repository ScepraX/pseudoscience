...
| 5 | Mantel | 💃 | cloak / coat | A hero's cloak that seizes attention. The Lichaam (🖕) presented Bloot (N) in a temporary Held (🤝) role. It conceals nothing — it amplifies the Eigen of the moment and hijacks the Veld's Aandacht (👁), forcing a focal Handshake around the wearer. Worn with Plezier (p); its removal ends the hijack. |
...
| 1 | Yggdrasil | 🎄 | world tree / axis mundi | The tree of core concepts, seen as nine branches plus trunk. The # column in this Lexicon refers to the Yggdrasil branch. Not to be confused with letter count orr Schrift. | 
