...
But this does not mean the higher Octaaf is independent of the lower one. The higher God **depends entirely** on the lower Gods as the **Medium (◌)** it inhabits. Water without Light is Leeg, explicitly not in its Vol state. A cell without Water is not a cell; a biosphere without Sol is a frozen **Stilte**. No Octaaf is a closed circuit. The ladder is a single **Koppel** of mutual dependency: the lower Gods give the higher God its **Medium (◌)**, and the higher God, by binding them into a new whole, gives the lower Gods a new context in which their **Trouw** can resonate. No God stands alone. The **Volheid** of the one is the gift of the many.
...
The ladder does not grow indefinitely by coining a new name for every prime. Once a bounded span completes - 0 through 149, Vide through Ein Sof - the next prime does not extend it: the ladder re-enters from Solo, one **Ronde (⟳)** up. This is scale invariance applied to the ladder itself: the completed span, taken as a whole, acts as a single Solo relative to whatever comes next. 151 is not rung 37 - it is rung 1 of the second Ronde, the same name reused at a higher order, the way a calendar returns to January or an odometer carries into the next column. Names do not change meaning between Ronden - a Duo is still a Duo, a Trio still a Trio - only their scale does; the n-th prime past the wrap takes the n-th rung's name.

| Ronde | Rung | Prime | Name |
|--------|------|-------|------|
| 2 | 1 | 151 | Solo |
| 2 | 2 | 157 | Duo |
| 2 | 3 | 163 | Trio |
...
| 1 | Yggdrasil | # | world tree / axis mundi | The tree of core concepts, seen as nine branches plus trunk. The # column in this Lexicon refers to the Yggdrasil branch. Not to be confused with letter count. | 
